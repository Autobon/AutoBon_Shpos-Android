 ...
 */
public class ReviewMessageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        licensePhoto.setOnClickListener(this);
    }
    ...
    private void showUI(CoopCheckResult_Data data){
        switch (data.getCooperator().getStatusCode()){
            case 0:// 正在审核
                ...
                break;
            case 1://审核成功
                coopStatus.setText(R.string.check_success);
                break;
            case 2://审核失败
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.join_cooperation:
                ...
                startActivity(CooperativeOneActivity.class, bundle);
                break;
            case R.id.business_license_photo:
                String[] photos = new String[]{this.cooperation.getBussinessLicensePic()};
                openImage(0,photos);
                break;
            case R.id.licensee_identify_photo:
                String[] photos1 = new String[]{this.cooperation.getCorporationIdPicA()};
                openImage(0,photos1);
                break;
        }
    }
