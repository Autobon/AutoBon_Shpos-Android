...
////
//	/** 田野服务器基地址 */
//	public final static String BASE_URL = "http://10.0.14.19:12345/api/mobile/";
//	public final static String IP_PORT = "http://10.0.14.19:12345";
//	public static final String PUB = "http://10.0.14.19:12345/api/pub/";
...
//	public static final String PUB = "http://121.40.157.200:12345/api/pub/";
     ...
     * 查询商户报价列表
     */
    public static final String SELECTPRODUCT = BASE_URL + "product/offer";

    /**
     * 添加报价产品到套餐中
     */
    public static final String ADDPRODUCTTOSETMEAL = BASE_URL + "product/offer/set/menu/add";

    /**
     * 从套餐中移除报价产品
     */
    public static final String DELETEPRODUCTTOSETMEAL = BASE_URL + "product/offer/set/menu/remove";

    /**
     * 查询商户套餐列表
     */
    public static final String SELECTSETMEAL = BASE_URL + "product/offer/set/menu";


    /**
     * 查询商户套餐详情
     */
    public static final String selectSetMealInfo(int id) {
        return SELECTSETMEAL + "/" + id;
    }

    /**
     * 查询商户套餐详情
     */
    public static final String deleteSetMeal(int id) {
        return SELECTSETMEAL + "/" + id;
    }
     ...
     * 添加套餐
     */
    public static final String ADDSETMEAL = BASE_URL + "product/offer/set/menu/create";

    /**
     * 数据下单
     */
    public static final String CREATEORDERFROMDATA = BASE_URL + "coop/merchant/data/order";
