...
public class MainReviewActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void getServiceData() {
        showDialog();
        Http.getInstance().getTaskToken(NetURL.COOP_CHECK_RESULT, "", CoopCheckResultEntity.class, new OnResult() {
            @Override
            public void onResult(Object entity) {
                ...
                if (entity instanceof CoopCheckResultEntity){
                    ...
                    if (coop.isResult() && coop.getData().getCooperator() != null){
                        showUI(coop.getData());
                    }else {
                        T.show(getContext(), R.string.loading_data_failed);
                        return;
    ...
    private void showUI(CoopCheckResultEntity.CoopCheckResult_Data data){
