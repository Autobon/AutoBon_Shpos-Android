 ...
 */
public class OrderYetSelectProductPopupwindow extends PopupWindow {
    ...
    public OrderYetSelectProductPopupwindow(Activity context) {
        this.context = context;
    }

    public void init() {

        View view = LayoutInflater.from(context).inflate(R.layout.pop_window_yet_select_product, null, false);
...
//        mAdapter.update(true);
    ...
    public void setListViewHeightBasedOnChildren(ListView listView) {
        ...
        if (params.height > dip2px(context,340f)) {
